...
object TimeFormatters {
    fun relativeTime(context: Context, epochMillis: Long?): String {
        epochMillis ?: return context.getString(R.string.relative_time_unknown)
        ...
        return when {
            ...
            minutes < 24 * 60 -> context.getString(R.string.relative_time_hours_ago, minutes / 60)
            else -> context.getString(R.string.relative_time_days_ago, minutes / (24 * 60))
        }
    }

    fun sleepDuration(totalMinutes: Int): String {
